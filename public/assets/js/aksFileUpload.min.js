  ...
  a.fn.aksFileUpload = function (l) {
    ...
    var i = a.extend(
      {
        ...
        maxSize: "",
        ajaxUpload: !1,
        ajax: { directlyLoad: !1, url: "upload.php", type: "POST", data: "formData", contentType: !1, processData: !1, cache: !1, async: !0, enctype: "multipart/form-data" },
    ...
    return this.each(function (l) {
      ...
      function f(a) {
        ...
        $("label.aks-file-upload-label").show();
        $("aks-file-upload-error").show();
        e.find(".aks-file-upload").append(l);
      }
      function r(a) {
        if (0 == a) return "0 BYTE";
        var l = parseInt(Math.floor(Math.log(a) / Math.log(1024)));
        return Math.round(a / Math.pow(1024, l), 2) + " " + ["BYTE", "KB", "MB", "GB", "TB"][l];
      }
      e.append(o),
        e.find(".aks-file-upload").append('<div class="aks-file-upload-content"></div>'),
        (function () {
          var a = e.find(".aks-file-upload-content"),
            l = '<label for="' + t + '" class="aks-file-upload-label"><span>' + i.label + "</span></label>";
          a.append(l);
        })(),
        (Object.size = function (a) {
          var l,
            e = 0;
          for (l in a) a.hasOwnProperty(l) && e++;
          return e;
        });
      var d = {},
        h = {},
        n = new FormData();
      function c(l) {
        var e = a(i.fileUpload).attr("type");
        "file" === e || ("json" === e ? a(i.fileUpload).html(JSON.stringify(h)) : a(i.fileUpload).val(JSON.stringify(h)));
      }
      function p(a) {
        delete d["file-" + a], delete h["file-" + a], n.append("file", d), c();
      }
      function v(l) {
        var t, s, o;
        (s = d["file-" + (t = l).name] = t), (o = { name: t.name, size: r(t.size), type: t.name.split(".").pop().toLowerCase() }), (h["file-" + t.name] = o), n.append("file", s), c();
        var v = l.name,
          g = r(l.size),
          u = l.type,
          m = l.name.split(".").pop().toLowerCase(),
          w = i.fileType.indexOf(m) > -1;
        Object.size(h) > i.maxFile
          ? (f(i.maxFileError + " " + i.maxFile), p(v))
          : w
            ? l.size >
              (function () {
                var a = i.maxSize.split(/\s+/),
                  e = a[0],
                  t = a[1].toLowerCase(),
                  s = r(l.size).split(/\s+/),
                  o = (s[0], s[1].toLowerCase(), "");
                "kb" === t
                  ? (o = 1e3 * e)
                  : "bytes" === t
                    ? (o = 1 * e)
              ...
              ? (f('"' + v + '" ' + i.maxSizeError + " " + i.maxSize), p(v))
              : (function () {
                if ("image/png" === u) var t = "png";
                var s = "";
                s = l.type.match("image.*")
                ...
                var r = "",
                  d = "";
                !0 === i.ajaxUpload
                  ? !0 === i.ajax.directlyLoad
                    ? ((r = '<div style="display:none;">' + f()), o(), (d = '<div data-upload-bar="' + v + '" class="aks-uplaod-bar"></div>'))
                    : ((r = f()), (d = '<div data-upload-bar="' + v + '" class="aks-uplaod-bar"></div>'))
                  : (r = o());
                if (l.type.match("image.*")) {
                  ...
                  (c.onload = function (a) {
                    (h["file-" + v].width = c.naturalWidth), (h["file-" + v].height = c.naturalHeight);
                  }),
                    (n.onload = function (l) {
                      h["file-" + v].base64 = l.target.result;
                      var i =
                        '<div data-file="' +
                        v +
                        '" data-file-type="' +
                        ...
                        s +
                        '</div><div class="aks-file-upload-p-header-content"><span class="aks-file-upload-title">' +
                        v +
                        '</span><span class="aks-file-upload-size">' +
                        g +
                        "</span></div>" +
                        r +
                        ...
                        t +
                        '" /></div></main></div>',
                        o = e.find(".aks-file-upload-content");
                      a(o).append(i), a('[data-file="' + v + '"]').animate({ height: 240 }, 200), a('[data-file="' + v + '"]').fadeIn(650);
                    }),
                    (c.src = p.createObjectURL(l)),
                    n.readAsDataURL(l);
                } else {
                  var w =
                    '<div data-file="' +
                    ...
                    r +
                    "</header></div>",
                    x = e.find(".aks-file-upload-content");
                  a(x).append(w), a('[data-file="' + v + '"]').animate({ height: 55 }, 200), a('[data-file="' + v + '"]').fadeIn(650);
                }
              })()
            : (f('"' + m + '" ' + i.fileTypeError), p(v));
      }
      var g = [];
      if (!0 === i.dragDrop) {
        var u = e.find(".aks-file-upload");
        a(u).on("dragenter", function (l) {
          a(u).addClass("drop-active");
        }),
          a(u).on("dragover", function (l) {
            a(u).addClass("drop-active"), l.preventDefault();
          }),
          a(u).on("dragleave", function (l) {
            a(u).removeClass("drop-active");
          }),
          a(u).on("drop", function (l) {
            if ((l.preventDefault(), l.stopPropagation(), l.originalEvent.dataTransfer && l.originalEvent.dataTransfer.files.length)) for (var e = l.originalEvent.dataTransfer.files, i = 0; i < e.length; i++) v(e[i]);
            return a(u).removeClass("highlightDropArea"), !1;
          });
      }
      a(i.input).on("change", function () {
        $("label.aks-file-upload-label").hide();
        $("aks-file-upload-error").hide();
        var a;
        (a = this.files),
        ...
        setInterval(function () {
          a(".aks-file-upload-delete").on("click", function () {
            $("label.aks-file-upload-label").show();
            var l = a(this).data("delete"),
              e = a('[data-file="' + l + '"]');
            a(e).animate({ height: 0 }, 200), a(e).fadeIn(650), a(e).remove(), p(l);
          }),
            !0 === i.ajaxUpload &&
            (a(".aks-file-upload-btn").click(function () {
              var l = a(this).data("upload");
              n.append("file", d["file-" + l]),
                a.ajax({
                  url: i.ajax.url,
                  type: i.ajax.type,
                  async: i.ajax.async,
                  data: n,
                  contentType: i.ajax.contentType,
                  processData: i.ajax.processData,
                  cache: i.ajax.cache,
                  enctype: i.ajax.enctype,
                  xhr: function () {
                    var e = a.ajaxSettings.xhr();
                    return (
                      e.upload &&
                      (setTimeout(function () {
                        a('[data-upload="' + l + '"]').remove();
                      }, 40),
                        setTimeout(function () {
                          a('[data-file="' + l + '"] .aks-file-upload-p-header').append(
                            '<div class="aks-file-upload-delete" data-delete="' +
                            l +
                            '"><svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M11.586 13l-2.293 2.293a1 1 0 0 0 1.414 1.414L13 14.414l2.293 2.293a1 1 0 0 0 1.414-1.414L14.414 13l2.293-2.293a1 1 0 0 0-1.414-1.414L13 11.586l-2.293-2.293a1 1 0 0 0-1.414 1.414L11.586 13z" fill="currentColor" fill-rule="nonzero"></path></svg></div>'
                          );
                        ...
                        e.upload.addEventListener(
                          ...
                          function (e) {
                            var i = 0;
                            e.lengthComputable && (i = Math.ceil((e.loaded / e.total) * 100)), a('[data-upload-bar="' + l + '"]').css("width", i + "%");
                          },
                          !1
                        )),
                      e
                  ...
                  success: function (e) {
                    0 != e ? ((h["file-" + l].src = e), c(), a('[data-upload-bar="' + l + '"]').css("width", "100%")) : a('[data-upload-bar="' + l + '"]').css("background", "#ff0000");
                  },
                });
            }),
              !0 === i.ajax.directlyLoad &&
              a(".aks-file-upload-btn").each(function (l, e) {
                a(e).click();
              }));
        }, 3e3);
    });
