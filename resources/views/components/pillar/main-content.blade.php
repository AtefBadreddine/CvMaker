    ...
    <table >
        ...
        @isset($cv->jobs)
            @foreach ($cv->jobs as  $job)
                <tr>
                    <td style="width: 25%;vertical-align:top" class="gray-text">{{$job['jobStartYear'] ?? ""}} - {{$job['jobEndYear'] ?? ""}}</td>
                    <td scope="col">
    ...
    <table >
        ...
        @isset($cv->educations)
            @foreach ($cv->educations as  $education)
                <tr>
                    <td style="width: 25%" class="gray-text">{{$education['startYear'] ?? ""}} - {{$education['endYear'] ?? ""}}</td>
                    <td scope="col">
