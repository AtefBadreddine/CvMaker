...
<div id="pdf-main-container">
	...
	<div id="pdf-contents" style="position:relative">
      ...
      <div id="pdf-meta">
			<div id="pdf-buttons">
                <button id="pdf-prev" class="btn btn-sm btn-secondary">{{__('labels.prev')}}</button>
                <button id="pdf-next" class="btn btn-sm btn-primary">{{__('labels.continue')}}</button>
			</div>
			<div id="page-count-container">{{__('labels.page')}} <div id="pdf-current-page"></div>/<div id="pdf-total-pages"></div></div>
      </div>
    ...
    @if(!request()->query('pdf'))
          ...
          <a class="btn btn-link text-dark fw-bold" href="{{route('step.template')}}">{{__('steps-bar.two')}}</a>
          <a
