                    ...
                    <div class="w-100">
                        <h4 class="d-flex align-items-center">
                            <i class="bi bi-translate"></i>
                          	<input type="text" class="w-100 form-control rounded-pill border-1 fs-5 mx-1" name="langs_section_title" value="{{__('pdf-sections.languages')}}" placeholder="{{__('pdf-sections.languages')}}" />
                        </h4>
                        <small class="text-muted">{{__('pdf-sections.languages_desc')}}</small>
                    </div>
                </div>
                <div id="collapse1">
                    <div class="card-body">
                    ...
                    <div class="w-100">
                        <h4 class="d-flex align-items-center">
                            <i class="bi bi-magic"></i>
                          	<input type="text" class="w-100 form-control rounded-pill border-1 fs-5 mx-1" name="skills_section_title" value="{{__('pdf-sections.skills')}}" placeholder="{{__('pdf-sections.skills')}}" />
                        </h4>
                        <small class="text-muted">{{__('pdf-sections.skills_desc')}}</small>
                    </div>
                </div>
                <div id="collapse2">
                    <div class="card-body">
                ...
                <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                    <div class="w-100">
                        <h4 class="d-flex align-items-center">
                          ...
                          <input type="text" class="w-100 form-control rounded-pill border-1 fs-5 mx-1" name="summary_section_title" value="{{__('pdf-sections.summary')}}" placeholder="{{__('pdf-sections.summary')}}" />
                        </h4>
                        <small class="text-muted">{{__('pdf-sections.summary_desc')}}</small>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                ...
                <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                    <div>
                        <h4 class="d-flex align-items-center">
                            ...
                            <input type="text" style="width:580px" class="form-control rounded-pill border-1 fs-5 mx-1" name="certs_section_title" value="{{__('pdf-sections.certs')}}" placeholder="{{__('pdf-sections.certs')}}" />
                        </h4>
                        <small class="text-primary">{{__('pdf-sections.optional_section')}}</small>
                    </div>
                </div>
                <div id="collapse6">
                    <div class="card-body">
            ...
            <div class="card border-0 p-md-5 p-sm-1  collapse @isset($cv->ref) show @endisset" id="collapseRefs">
                <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                    <div>
                        <h4 class="d-flex align-items-center">
                            <i class="bi bi-pen"></i>
                            <input type="text" style="width:580px" class="form-control rounded-pill border-1 fs-5 mx-1" name="refs_section_title" value="{{__('pdf-sections.refs')}}" placeholder="{{__('pdf-sections.refs')}}" />
                        </h4>
                        <small class="text-primary">{{__('pdf-sections.optional_section')}}</small>
                    </div>
                </div>
                ...
                <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                    <div>
                        <h4 class="d-flex align-items-center">
                          ...
                          <input type="text" style="width:580px" class="form-control rounded-pill border-1 fs-5 mx-1" name="interests_section_title" value="{{__('pdf-sections.interests')}}" placeholder="{{__('pdf-sections.intersts')}}" />
                        </h4>
                        <small class="text-primary">{{__('pdf-sections.optional_section')}}</small>
                    </div>
                </div>
                ...
                <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                    <div>
                        <h4 class="d-flex">
                            ...
                            <input type="text" style="580px" name="customSectionTitle" value="{{old('customSectionTitle') ?? ($cv->customSectionTitle ?? '')}}" class="form-control rounded-pill form-control-lg mx-2 vertical-align-middle border-1" placeholder="{{__('labels.customSectionTitle')}}" />
                        </h4>
                    </div>
                    <button type="button" class="btn btn-outline-danger border-0 removeElement">
                        <i class="bi bi-trash3 fs-5 mx-2"></i>
                        ...
                        <div class="card shadow border-0 p-md-5 p-sm-1 mt-5 structure deletable" id="customSections">
                            <div class="card-header bg-white d-flex justify-content-between flex-wrap">
                                <div>
                                    <h4 class="d-flex">
                                        <i class="bi bi-bandaid mt-2"></i>
                                        <input type="text" name="customSections[{{$loop->iteration}}][customSectionTitle]" value="{{$section['customSectionTitle']}}" class="form-control form-control-lg mx-2 vertical-align-middle border-0 w-100 px-0" />
                                    </h4>
                                </div>
                                <button type="button" class="btn btn-outline-danger border-0 removeElement">
                                    <i class="bi bi-trash3 fs-5 mx-2"></i>
