<table>
    ...
    <tr>
        <th class="sidebar-title"><?php echo e(__('pdf-sections.profile')); ?></th>
    </tr>
    <?php if($cv->email): ?>
        <tr>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\cvmaker\resources\views/components/pillar/sidebar.blade.php ENDPATH**/ ?>