...
<?php $__env->startSection('PAGE_TITLE', 'إستعراض سيرتك الذاتية'); ?>
        ...
        <div class="card-body p-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <iframe id="pdfPreview" src="<?php echo e(url('cv')); ?>" allowfullscreen scrolling="no" frameborder="0" width="100%" height="1000"></iframe>
                </div>
                    ...
                    <div class="row mt-4 justify-content-center align-items-center">
                        <div class="col-md-5 col-sm-12">
                            <a class="btn btn-primary btn-lg fw-bold w-100 d-flex flex-column justify-content-evenly" style="margin-top: 10px; height:120px"
                                href="<?php echo e(asset('storage') . '/cvs/' . Session::get('fileName') . '1.pdf'); ?>" download="<?php echo e($cv->name); ?>">
                                <i class="bi bi-download mx-2 fs-2"></i>
                                <?php echo e(__('general.downloadBtn')); ?>
                        ...
                        <div class="col-md-5 col-sm-12">
                            <a class="btn btn-outline-primary btn-lg fw-bold w-100 d-flex flex-column justify-content-evenly" style="margin-top: 10px; height:120px"
                                href="<?php echo e(asset('storage') . '/cvs/' . Session::get('fileName') . '1.pdf'); ?>" target="_blank">
                                <i class="bi bi-printer mx-2 fs-2"></i>
                                <?php echo e(__('general.printBtn')); ?>
                        ...
                        <div class="d-lg-none d-sm-block w-100">
                            ...
                            <li><a class="list-group-item" href="<?php echo e(route('step.one')); ?>"><i class="bi bi-file-earmark-person"></i> <?php echo e(__('steps-bar.three')); ?></a></li>
                            <li><a class="list-group-item" href="<?php echo e(route('step.two')); ?>"><i class="bi bi-award-fill"></i> <?php echo e(__('steps-bar.four')); ?></a></li>
                            <li><a class="list-group-item" href="<?php echo e(route('step.three')); ?>"><i class="bi bi-briefcase-fill"></i> <?php echo e(__('steps-bar.five')); ?></a></li>
                            <li><a class="list-group-item" href="<?php echo e(route('step.four')); ?>"><i class="bi bi-bag-plus-fill"></i> <?php echo e(__('steps-bar.six')); ?></a></li>
                            </ul>
                        </div>
                        </div>
                    </div>
                            ...
                            <form id="stepsForm">
                                <div class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <strong><?php echo e(__('general.fontSize')); ?></strong>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <strong><?php echo e(__('general.cvColor')); ?></strong>
...
<?php echo $__env->make('layouts.no-preview-step', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cvmaker\resources\views/pages/preview.blade.php ENDPATH**/ ?>