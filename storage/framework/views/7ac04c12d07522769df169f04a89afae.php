<table>
    ...
    <tr>
        <th class="sidebar-title" style="padding-top:20px;padding-bottom:20px;"><?php echo e(__('pdf-sections.profile')); ?></th>
    </tr>
    <?php if($cv->email): ?>
        <tr>
            <td><strong><?php echo e(__('labels.email')); ?>:<br/></strong><?php echo e($cv->email); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->phone): ?>
        <tr>
            <td><strong><?php echo e(__('labels.phone')); ?>:<br/></strong><?php echo e($cv->phone); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->address): ?>
        <tr>
            <td><strong><?php echo e(__('labels.address')); ?>:<br/></strong><?php echo e($cv->address); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->city): ?>
        <tr>
            <td><strong><?php echo e(__('labels.city')); ?>:<br/></strong><?php echo e($cv->city); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->birth_date): ?>
        <tr>
            <td><strong><?php echo e(__('labels.birth_date')); ?>:<br/></strong><?php echo e($cv->birth_date); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->marital_status): ?>
        <tr>
            <td><strong><?php echo e(__('labels.marital_status')); ?>:<br/></strong><?php echo e($cv->marital_status); ?></td>
        </tr>
    <?php endif; ?>
    <?php if($cv->nationality): ?>
        <tr>
            <td><strong><?php echo e(__('labels.nationality')); ?>:<br/></strong><?php echo e($cv->nationality); ?></td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\cvmaker\resources\views/components/simple-dev/sidebar.blade.php ENDPATH**/ ?>