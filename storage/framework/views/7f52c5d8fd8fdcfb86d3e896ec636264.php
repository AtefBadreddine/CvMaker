<table >
    <thead>
    <tr>
        <th class="section-title" style="font-size:40px;padding-bottom:0"><?php echo e($cv->name ?? ""); ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
    ...
    <table >
        ...
        <?php if(isset($cv->jobs)): ?>
            <?php $__currentLoopData = $cv->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td scope="col" style="padding-bottom:0"><strong><span class="title"><?php echo e($job['job_title'] ?? ""); ?></span> </strong> <?php echo e(isset($job['employer']) ? '| '.$job['employer'] : ""); ?></td>
                </tr>
                <tr>
    ...
    <table >
        ...
        <?php if(isset($cv->educations)): ?>
            <?php $__currentLoopData = $cv->educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="padding-bottom:0"><strong class="title"><?php echo e($education['university'] ?? ""); ?><?php echo e(isset($education['education_city']) ? ', '.$education['education_city'] : ""); ?></strong>, </td>
                </tr>
                <tr>
...
<?php if(isset($cv->customSections)): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH D:\laragon\www\cvmaker\resources\views/components/simple-dev/main-content.blade.php ENDPATH**/ ?>