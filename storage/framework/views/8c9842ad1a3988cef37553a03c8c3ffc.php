    ...
    <table >
        ...
        <?php if(isset($cv->educations)): ?>
            <?php $__currentLoopData = $cv->educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="width: 15%" class="gray-text"><?php echo e($education['startYear'] ?? ""); ?><?php echo e(isset($education['endYear']) ? ' - '.$education['endYear'] : ""); ?></td>
                    <td scope="col">
...
<?php if(isset($cv->customSections)): ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH D:\laragon\www\cvmaker\resources\views/components/pillar-dev/main-content.blade.php ENDPATH**/ ?>