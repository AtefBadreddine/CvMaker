...
?>
<html lang="<?php echo e(app()->currentLocale()); ?>" dir="<?php echo e(app()->currentLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@100;200;300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('assets/css/styles.css')); ?>?v=<?php echo e(rand(1, 999)); ?>" rel="stylesheet" />
    <?php if(app()->currentLocale() == 'ar'): ?>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.rtl.min.css"
            integrity="sha384-DOXMLfHhQkvFFp+rWTZwVlPVqdIhpDVYT9csOnHSgWQWPX0v5MCGtjCJbY6ERspU" crossorigin="anonymous">
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/custom-rtl.css') . '?v=' . rand(1, 999)); ?>" />
    <?php endif; ?>
    ...
    <?php echo $__env->yieldPushContent('HEAD_BOTTOM'); ?>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <?php echo $__env->yieldPushContent('BODY_BOTTOM'); ?>
</body>

</html>
<?php /**PATH D:\laragon\www\cvmaker\resources\views/layouts/abstract.blade.php ENDPATH**/ ?>